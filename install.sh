...
# Get our installer
wget --no-check-certificate  -O /usr/local/virtualizor/install.php https://raw.githubusercontent.com/donyayeserver/Control-Panel-Virtualizor/main/install.inc >> $LOG 2>&1
